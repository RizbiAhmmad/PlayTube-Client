...
const testimonials = [
  {
    ...
    content:
      "PlayTube has completely changed how I watch movies. The library is massive and the quality is unbeatable.",
  ...
  },
  {
    ...
    role: "Tech Reviewer",
    content:
      "The seamless switching between devices is what sold me. I can start a movie on my TV and finish it on my tablet.",
  ...
  },
  {
    ...
    role: "Student",
    content:
      "As a student on a budget, the free tier is amazing, but I eventually upgraded to Premium for the 4K content.",
      ...
      <div className="container mx-auto px-8">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Join millions of happy subscribers who have already discovered their
            new favorite home for cinema.
          </p>
        </div>
