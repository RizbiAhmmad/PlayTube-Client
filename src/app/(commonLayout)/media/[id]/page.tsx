            ...
            <div className="flex flex-col justify-end space-y-6">
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-3">
                    <Badge variant="outline" className="border-primary/50 text-xs text-primary backdrop-blur-md">
                        {media.pricingType}
                    </Badge>
              ...
              <div className="flex flex-wrap gap-2">
                {media.genres.map((genre) => (
                  <Badge key={genre} variant="secondary" className="px-4 py-1.5 text-xs font-semibold uppercase tracking-wider">
                    {genre}
                  </Badge>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                {media.trailerUrl && (
                  <Link href={media.trailerUrl} target="_blank">
                    <Button size="lg" variant="outline" className="h-14 gap-3 border-white/20 bg-white/10 px-8 text-lg font-bold backdrop-blur-md hover:bg-white/20 transition-all">
        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_350px]">
          ...
          <div className="space-y-12">
            <section className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tight border-l-4 border-primary pl-4">Synopsis</h2>
            ...
            <section className="space-y-6">
               ...
               <div className="grid gap-6 sm:grid-cols-2">
                  <div className="rounded-2xl border bg-muted/30 p-6 shadow-sm">
                      <p className="text-sm font-bold uppercase tracking-widest text-primary mb-2">Director</p>
                      <p className="text-xl font-semibold">{media.director}</p>
                  </div>
                  <div className="rounded-2xl border bg-muted/30 p-6 shadow-sm">
                      <p className="text-sm font-bold uppercase tracking-widest text-primary mb-2">Main Cast</p>
                      <div className="flex flex-wrap gap-2">
                         {media.cast.map(person => (
                            <span key={person} className="inline-flex items-center rounded-full bg-background px-3 py-1 text-sm font-medium border">
                               {person}
                            </span>
                         ))}
                      </div>
          ...
          <aside className="space-y-8">
             ...
             <div className="rounded-3xl bg-primary/5 p-8 border border-primary/10">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                   Enjoy cinematic experience with 4K UHD and Dolby Atmos and HDR support.
                </p>
