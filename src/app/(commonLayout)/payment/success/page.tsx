                ...
                <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/5 backdrop-blur-2xl p-8 md:p-12 shadow-2xl transition-all hover:shadow-green-500/10 dark:bg-black/20">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <motion.h1 
                            ...
                            className="bg-gradient-to-r from-white to-white/70 bg-clip-text text-4xl font-black tracking-tight text-transparent md:text-5xl"
                        >
                            Payment Received!
                        </motion.h1>
                        ...
                        >
                            Your transaction was successful. Get ready to dive into the world of premium cinema.
                        </motion.p>
                        ...
                        >
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <Button asChild size="lg" className="h-14 rounded-2xl text-base font-semibold transition-all hover:scale-[1.02] active:scale-95">
                                    <Link href="/dashboard/purchase-history">
                                        <ShoppingBag className="mr-2 h-5 w-5" />
                                        View Order History
                                    </Link>
                                </Button>
                                <Button asChild variant="outline" size="lg" className="h-14 rounded-2xl border-white/10 bg-white/5 text-base font-semibold backdrop-blur-sm transition-all hover:bg-white/10 hover:scale-[1.02] active:scale-95">
                                    <Link href="/dashboard">
                                        Back to Dashboard
                            ...
                            {sessionId && (
                                <div className="mt-8 flex flex-col items-center gap-2 rounded-2xl bg-white/5 p-4 border border-white/5 backdrop-blur-sm">
                                    <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground/60">Transaction Reference</span>
                                    <code className="text-sm font-mono text-primary/80 break-all px-4">{sessionId}</code>
                                    <Button variant="ghost" size="sm" className="mt-2 text-xs h-8 hover:bg-white/10">
