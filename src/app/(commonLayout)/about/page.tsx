          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight">
                Reimagining the{" "}
                <span className="text-primary italic">Cinematic</span>{" "}
                Experience.
              </h1>
              <p className="text-muted-foreground text-xl md:text-2xl leading-relaxed max-w-3xl">
                PlayTube started with a simple idea: make the world&apos;s best
                stories accessible to everyone, everywhere, with zero compromise
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
                Our Mission is to{" "}
                <span className="text-primary font-serif italic">Inspire</span>{" "}
                Every Viewer.
              </h2>
              <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                <p>
                  At PlayTube, we believe that great stories shouldn&apos;t just
                  be watched—they should be experienced. We&apos;ve spent
                  thousands of hours perfecting our streaming infrastructure to
                  ensure that every pixel and every sound wave reaches you
                  exactly as the filmmakers intended.
                </p>
                <p>
                  Whether it&apos;s an indie documentary or a high-budget sci-fi
                  epic, we provide the platform for creators to shine and for
                  audiences to be transported to different worlds.
                </p>
              </div>
              <div className="flex items-center gap-4 p-6 bg-muted rounded-3xl border border-border/50">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We prioritize your data privacy and security above
                    everything else.
                  </p>
                </div>
              </div>
